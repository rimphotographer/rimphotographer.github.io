...
$header .= "From: Новая заявка <dmitri.dwp@gmail.com>\n\n";	
$mail = mail("dmitri.dwp@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
